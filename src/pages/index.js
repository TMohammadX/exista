      ...
      {loading ? (
        ...
        >
          ...
          <Link
            ...
            className="hidden sms:block relative w-[8%] transition-all duration-300 bg-center bg-cover cursor-pointer h-3/5 bg-t hover:aspect-square grayscale hover:grayscale-0 box"
            target="_blank"
          >
          ...
          <Link
            ...
            className="hidden sms:block relative w-[8%] transition-all duration-300 bg-center bg-cover cursor-pointer h-3/5 bg-m hover:aspect-square grayscale hover:grayscale-0 box "
            target="_blank"
          >
            <span className="absolute w-px h-full mt-5 bg-gray-400 left-1/2 top-full"></span>
          </Link>
          ...
          <motion.div className="grid absolute gap-y-4 gap-x-4 px sms:hidden  m-0 px-5 grid-cols-3 grid-rows-2 w-screen	top-[12%] ">
            <motion.div className=" w-[100%] col-span-2 h-[20vh] bg-gray-400 rounded-ss-[50px]	rounded-ee-[50px] rounded"></motion.div>
            <motion.div className="  w-[100%] col-span-1 h-[20vh] bg-black rounded-ss-[30px]	rounded-ee-[30px] rounded"></motion.div>
            <motion.div className="  w-[100%] col-span-1  h-[20vh] bg-black rounded-ss-[30px]	rounded-ee-[30px] rounded"></motion.div>
